...
export class StatsController {
  ...
  @ApiOperation({ 
    ...
    description: 'Truy xuất 5 bản ghi mới nhất từ mỗi model (User, Post, Event, Permission) và liên kết các bảng lại với nhau, sắp xếp theo thời gian tạo. Chỉ Admin và BOD mới có thể truy cập.'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({ 
    ...
    description: 'Tính toán và trả về số lượng bản ghi mới trong tháng hiện tại so với tháng trước cho các model: User, Post, Event, Library. Chỉ Admin và BOD mới có thể truy cập.'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({ 
    ...
    description: 'Trả về cả thông tin 5 bản ghi mới nhất và thống kê tháng hiện tại so với tháng trước trong một API call. Chỉ Admin và BOD mới có thể truy cập.'
  })
  @ApiResponse({
    status: 200,
