...
export class CommentController {
  ...
  ): Promise<{ comments: Comment[]; pagination: { total: number, page: number, limit: number } }> {
  ...
  async update(@Param('id') id: string, @Body() updateCommentDto: UpdateCommentDto, @Request() req): Promise<Comment> {
