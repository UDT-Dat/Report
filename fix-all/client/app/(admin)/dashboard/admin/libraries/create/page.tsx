	...
	const onSubmit = async (values: CreateLibraryFormValues) => {
		...
		try {
			...
			if (response.status === 201) {
				...
				router.push('/dashboard/admin/libraries');
			} else {
				toast({
					title: 'Lỗi',
		...
		<div className="p-6 max-w-4xl mx-auto">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Điền thông tin cơ bản để tạo thư viện mới. Bạn có thể thêm tài liệu và quản lý quyền
						truy cập sau khi tạo thành công.
					</CardDescription>
				</CardHeader>
				<CardContent>
					<Form {...form}>
						<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel className="text-base font-semibold">Tiêu đề thư viện *</FormLabel>
										<FormControl>
											<Input
										...
										<FormDescription>
											Tên hiển thị của thư viện sẽ xuất hiện trong danh sách và kết quả tìm kiếm
											(tối đa 100 ký tự)
										</FormDescription>
										<FormMessage />
									</FormItem>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel className="text-base font-semibold">Mô tả chi tiết *</FormLabel>
										<FormControl>
											<Textarea
										...
										<FormDescription>
											Mô tả chi tiết giúp người dùng hiểu rõ hơn về nội dung và mục đích của thư
											viện (tối đa 500 ký tự)
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<ul className="text-sm text-blue-800 space-y-1">
								...
								<li>
									• Sau khi tạo, bạn có thể upload tài liệu và phân quyền truy cập cho từng thành
									viên
								</li>
							</ul>
						</div>
