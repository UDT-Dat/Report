...
export default function LoginPage() {
	...
	const handleLogin = async (e: React.FormEvent) => {
		...
		if (res.status === 201) {
			...
			if(res.result.user.status === UserStatus.PENDING ||
						...
						<div className="space-y-2">
							...
							<div className="relative">
								...
								<Input
									...
									className="pl-10 pr-10 h-12 bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 rounded-xl transition-all duration-200"
									required
								/>
							</div>
						</div>
