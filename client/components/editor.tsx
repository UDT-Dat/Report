...
export const RichTextEditor = ({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          `blog-content prose prose-neutral dark:prose-invert max-w-none rounded-md focus:outline-none ${!readOnly ? "border p-4 min-h-[500px]" : "border-none p-0 h-full shadow-none"}`,
      },
    },
    onUpdate: ({ editor }) => {
